...
import { ReplayableModal } from "../home/ReplayableModal";
import { MoveToHistoryModal } from "../home/MoveToHistoryModal";
import { DeleteConfirmModal } from "../home/DeleteConfirmModal";
import { useNavigate } from "react-router-dom";


export const HistoryGameDetailsModal = ({game, updateCategoryOnGame, userGames, setUserGames }) => {
    ...
    return <>
        ...
        <Modal
            ...
            fullscreen
        >
            <div className="game-details-background" style={{backgroundColor: "rgb(40, 0, 71)", backgroundImage : `linear-gradient(to left, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.5) 50%, rgba(0, 0, 0, 1)), linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.5) 50%, rgba(0, 0, 0, 1)), url(${game.gameSingle.background_image})`}}>
