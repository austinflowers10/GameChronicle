...
public class GameChronicleDbContext : IdentityDbContext<IdentityUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<UserGame>().HasData(new UserGame[]
        {
            ...
            new () {Id = 9, UserProfileId = 1, GameNumber = 22513, ReplayabilityRating = 5, TimeCategoryId = 5}, 
            new () {Id = 10, UserProfileId = 1, GameNumber = 3556, ReplayabilityRating = 7, FavoriteRanking = 9, TimeCategoryId = 5}, 
